...
var $author$project$Todo$init = function (_v0) {
	return _Utils_Tuple2(
		{inputText: '', todos: _List_Nil},
		$elm$core$Platform$Cmd$none);
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$Todo$addToList = F2(
	function (input, todosList) {
		return _Utils_ap(
			todosList,
			_List_fromArray(
				[
					{
					completed: false,
					index: $elm$core$List$length(todosList),
					text: input
				}
				]));
	});
			...
			case 'AddTodo':
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							inputText: '',
							todos: A2($author$project$Todo$addToList, model.inputText, model.todos)
						}),
					$elm$core$Platform$Cmd$none);
			case 'RemoveTodo':
				var index = message.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							todos: A2($author$project$Todo$removeFromList, index, model.todos)
						}),
					$elm$core$Platform$Cmd$none);
			case 'ToggleTodo':
				var index = message.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							todos: A2($author$project$Todo$toggleAtIndex, index, model.todos)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				var input = message.a;
...
var $author$project$Todo$AddTodo = {$: 'AddTodo'};
var $author$project$Todo$ChangeInput = function (a) {
...
var $author$project$Todo$ToggleTodo = function (a) {
...
var $author$project$Todo$main = $elm$browser$Browser$element(
	{
		init: $author$project$Todo$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$Todo$update,
		view: $author$project$Todo$view
	});
